package com.example.mybooklistapplication;
...
public class spUtil {
    private spUtil() {}
    public static final String PERF_NAME = "BooksPreferences";
    public static final String POSITIVE = "position";
    public static final String QUERY = "query";

    public static SharedPreferences getPrefs(Context context) {
        return context.getSharedPreferences(PERF_NAME, Context.MODE_PRIVATE);
    }
